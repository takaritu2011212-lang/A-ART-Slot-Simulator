...
class GameStorage {
    ...
    addArt(g) { this.data.artCount++; this.data.artTotalG += g; this.saveData(); }
    addSanku() { this.data.sankuCount++; this.saveData(); }
    addBurst() { this.data.burstCount++; this.saveData(); }
    addChallenge() { this.data.challengeCount++; this.saveData(); }
    addChallengeWin() { this.data.challengeWinCount++; this.saveData(); }
